...
OpenGymInterface::Init()
{
  ...
  //NS_LOG_UNCOND("Sending message to python");//weafre
  ...
  //NS_LOG_UNCOND("Received ack message from python");//weafre
...
//  NS_LOG_UNCOND("Sending env state msg");//weafre
  ...
  m_zmq_socket.send (request);
  //action taken from python (rep index) weafre
